...
class OfficeHours(Window):
    ...
    def mainMethod(self):
        ...
        if self.form.allButton.isChecked():
            ...
            result = Window.db.getOfficeHoursByTeacher(self.form.teacherList.currentText(), month = month, year = year)

        for i, elem in enumerate(result):
            if elem[3] is None and self.form.withoutRecButton.isChecked() or not self.form.withoutRecButton.isChecked():
